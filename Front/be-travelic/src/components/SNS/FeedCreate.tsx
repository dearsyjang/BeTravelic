...
function FeedCreate({ changeWriteHandler }: any) {
  ...
  const getPlaceList = async (value: any) => {
    ...
    const response = await axios.get(
      `http://j7d205.p.ssafy.io:8443/feed/travel-review`,
      {
        params: {
          regionId: value,
        },
  ...
  return (
    <div
      id="FeedCreateCard"
      className="justify-content-center items-center fadeIn"
    >
      <div
        id="FeedCreatePlace"
        className="flex items-center justify-center bg-gray-200 m-5 mb-0"
      >
      ...
      <div id="FeedCreatePhoto">
        <UploadPhoto type="place" feedImage={feedImage} />
      </div>

      <div
        id="FeedCreateContent"
